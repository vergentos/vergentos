...
export const mobileMenuData: MobileMenuGroup[] = [
  ...
  },
  {
    ...
    title: 'Services',
    submenu: [
      { id: 'nextjs', label: 'Next.js & React', href: '/services/nextjs-react' },
      { id: 'sage', label: 'Sage 50 Integration', href: '/services/sage-50-sync' },
      { id: 'ai', label: 'AI & Automation', href: '/services/ai-implementation' },
      { id: 'ecommerce', label: 'E-commerce', href: '/services/ecommerce-engineering' },
      { id: 'cms', label: 'Bespoke CMS', href: '/services/bespoke-cms' },
      { id: 'consultancy', label: 'Technical Consultancy', href: '/services/bespoke-consultancy' },
