...
// These cards stay consistent as they represent your general client base
const stackCards = [
  { icon: 'ns-shape-19', title: 'Startups', description: 'Launch your MVP quickly and validate your idea.' },
  { icon: 'ns-shape-35', title: 'Business teams', description: 'Automate workflows and streamline operations.' },
  { icon: 'ns-shape-4', title: 'Freelancers & agencies', description: 'Deliver custom apps to your clients with ease.' },
  { icon: 'ns-shape-21', title: 'Educators & creators', description: 'Build tools, portals, and learning apps fast.' },
];

// We add "props" here so the component can receive unique SEO text
const Integration = ({ 
  badge, 
  title, 
  description 
        ...
        <div className="flex flex-col items-start gap-y-10 pt-14 pb-14 md:gap-y-20 md:pt-16 md:pb-16 lg:flex-row lg:gap-[100px] lg:pt-[88px] lg:pb-[88px] xl:pt-[150px] xl:pb-[150px]">
          <div className="mx-auto w-full max-w-[520px] text-center lg:sticky lg:top-28 lg:mx-0 lg:max-w-full lg:flex-1 lg:text-left">
            <RevealAnimation delay={0.2}>
              {/* Uses the unique badge from our data library */}
              <span className="badge badge-green mb-5">{badge || "Integration"}</span>
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              {/* Uses the unique SEO title (e.g., 'Engineered for Speed') */}
              <h2 className="mb-3 whitespace-normal">
                {title || "Designed for ambitious brands"}
              </h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              {/* Uses the unique SEO description for this specific service */}
