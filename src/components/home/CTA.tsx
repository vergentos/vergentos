        ...
        <RevealAnimation delay={0.1}>
          <div className="bg-secondary dark:bg-background-8 relative overflow-hidden rounded-[20px] px-6 md:px-10 xl:px-20">
            ...
            <CTA
              ...
              description="Whether you require a high-performance Next.js platform or a custom Sage 50 API integration, our Bristol-based team is ready to build your solution. Contact Mediatopia.agency today."
