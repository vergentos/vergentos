        ...
        <div className="mb-14 flex flex-col items-center justify-center">
          <div className="mx-auto mb-14 w-full max-w-[1075px] space-y-4 text-center">
            <RevealAnimation delay={0.2}>
              <h1>
                Bespoke <span className="text-primary-500">web design &amp; apps </span>  built for performance and growth
              </h1>
                
            </RevealAnimation>
            <RevealAnimation delay={0.3}>
              <p className="mx-auto max-w-[650px]">
                Based in Bristol, Mediatopia.agency delivers high-performance web development, custom eCommerce platforms, and AI-driven digital strategies designed to scale ambitious brands.
              </p>
            </RevealAnimation>
          </div>
