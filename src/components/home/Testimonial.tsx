        ...
        <div className="mb-10 flex flex-col items-center text-center md:mb-[70px]">
          ...
          <RevealAnimation delay={0.3}>
            <p className="mx-auto max-w-[872px]">
              Trusted by industry leaders across the UK to deliver technical excellence. Discover how vergentos.com empowers brands through bespoke web engineering, custom API integrations, and AI-driven automation that drives real commercial growth.
            </p>
          </RevealAnimation>
        </div>
