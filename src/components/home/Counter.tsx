      ...
      <div className="main-container">
        <div className="text-center space-y-3 mb-10 md:mb-[70px]">
          <RevealAnimation delay={0.2}>
            <h2>Proven results for ambitious brands.</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.3}>
            <p className="max-w-[680px] mx-auto">
              Our track record in bespoke development and AI integration ensures your business stays ahead of the competition with measurable digital performance.
            </p>
          </RevealAnimation>
        </div>
        <RevealAnimation delay={0.4}>
          <div className="flex flex-col max-md:gap-y-10 max-lg:gap-x-4 md:flex-row justify-between bg-secondary dark:bg-background-8 rounded-[20px] px-3 lg:px-[60px] py-14">
            ...
            <div className="space-y-2 text-center">
              ...
              <p className="text-white/60">daily API data synchronisations.</p>
            </div>
            <div className="space-y-2 text-center">
              <h3 className="text-white flex items-center justify-center">
                <NumberAnimation number={95} speed={2000} interval={200} rooms={2} heightSpaceRatio={2} />%
              </h3>
              <p className="text-white/60">client satisfaction & retention rate.</p>
            </div>
            <div className="space-y-2 text-center">
              <h3 className="text-white flex items-center justify-center">
                <NumberAnimation number={23} speed={2000} interval={200} rooms={2} heightSpaceRatio={2} />+
              </h3>
              <p className="text-white/60">years of engineering expertise.</p>
            </div>
          </div>
        </RevealAnimation>
      </div>
