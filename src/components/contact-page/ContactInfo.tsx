...
const contactInfoItems = [
  {
    ...
    icon: homeIcon,
    title: 'Our Office',
    content: '12 Whiteladies Road, Bristol BS8 1PD',
  ...
  },
  {
    ...
    icon: mailIcon,
    title: 'Email Us',
    content: 'hello@aiwebdesigners.co.uk',
    link: 'mailto:hello@aiwebdesigners.co.uk',
  ...
  },
  {
    ...
    icon: phoneIcon,
    title: 'Call Us',
    content: '0117 332 6021',
    link: 'tel:+441173326021',
